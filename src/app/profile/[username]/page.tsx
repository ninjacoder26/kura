            ...
            <div className="sidebar-widget">
              ...
              <div className="p-3 space-y-3">
                ...
                <div className="flex items-center flex-wrap gap-x-3 gap-y-1 text-xs text-[var(--fg4)]">
                  ...
                  {profile.website && <a href={profile.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-[var(--brand-600)]"><LinkIcon className="h-3.5 w-3.5" /> {profile.website.replace(/https?:\/\//, '')}</a>}
