      ...
      <div className="w-full max-w-sm anim-fade-up">
        ...
        <div className="space-y-2 mb-4">
          <button onClick={() => handleOAuth('google')} type="button"
            className="reddit-btn w-full border border-[var(--border)] text-[var(--fg2)] hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)] bg-transparent text-sm py-2.5">
          ...
          <button onClick={() => handleOAuth('apple')} type="button"
            className="reddit-btn w-full border border-[var(--border)] text-[var(--fg2)] hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)] bg-transparent text-sm py-2.5">
            <Apple className="h-4 w-4 mr-2" fill="currentColor" />
            Continue with Apple
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button type="submit" disabled={loading} className="reddit-btn w-full bg-[var(--brand-600)] text-white hover:bg-[var(--brand-700)] disabled:opacity-50 py-2.5">
